...
/**
  ...
  * @brief  Provides LPBAM Master application ReloadSeq scenario build services
  **********************************************************************************************************************
  * @attention
  *
...
/* USER CODE BEGIN Master_Q_Master_Receive_Data_1_Desc[1] */

/* USER CODE END Master_Q_Master_Receive_Data_1_Desc[1] */
static LPBAM_I2C_MasterRxDataDesc_t Master_Q_Master_Receive_Data_1_Desc[1];
...
void MX_Master_ReloadSeq_Build(void)
{
  ...
  memset(Master_Q_Master_Transmit_Data_1_Desc, 0, sizeof(Master_Q_Master_Transmit_Data_1_Desc));
  memset(Master_Q_Master_Receive_Data_1_Desc, 0, sizeof(Master_Q_Master_Receive_Data_1_Desc));
...
static void MX_Master_Q_Build(void)
{
  ...
  pTxData_I2C.DevAddress = LPBAM_I2C3_ADDRESS << 1;
  pTxData_I2C.Size = 1;
  ...
  pRxData_I2C.DevAddress = LPBAM_I2C3_ADDRESS << 1;
  pRxData_I2C.Size = 1;
  /* Set transfer parameters */
